    ...
    <Layout>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hypetrigger.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hypetrigger, accessible from{' '}
            <a
              href="https://hypetrigger.io"
      ...
      <ul>
        <li>
          ...
          <a
            href="https://hypetrigger.io/discord"
            rel="external nofollow noopener"
            target="blank"
          >
            https://hypetrigger.io/discord
          </a>
        </li>
      </ul>
    </Layout>
